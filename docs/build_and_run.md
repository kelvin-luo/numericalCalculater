...
| Ninja | `D:\win10\ninja.exe` |
| Visual Studio 2022 | 含 MFC、x64 工具链 |
| OpenCV 5.0 | `D:\win10\opencv500\build` |
...
**注意**：请在 `msvc_release` 目录下启动，以便 `input/`、`../output/` 等相对路径正确解析。

### 默认输入数据

| 类型 | 相对路径 | 原始路径（构建时复制） |
|------|----------|------------------------|
| 图片 | `input/people.jpeg` | `D:\k8\media_images\xi_an_hot\people.jpeg` |
